...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{ route('blog.categori.create') }}" class="btn btn-primary btn-5">
                Tambah
            </a>
        </div>
                ...
                <tbody>
                    ...
                    @forelse ($categori as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('blog.categori.edit', ['id' => $item->id]) }}" class="btn btn-outline-warning">
                                    Edit
                                </a>
...
@push('js')
    <script>
        const BASE = "{{ route('blog.categori.index') }}";

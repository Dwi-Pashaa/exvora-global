    ...
    <div class="card mb-3">
                ...
                <tbody>
                    ...
                    @forelse ($blog as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('blog.edit', ['id' => $item->id]) }}" class="btn btn-outline-warning">
                                    Edit
                                </a>
        ...
        <div class="card-footer d-flex align-items-center">
            <p class="m-0 text-secondary">
                Showing <span>{{ $blog->firstItem() }}</span> 
                to <span>{{ $blog->lastItem() }}</span> of
                <span>{{ $blog->total() }}</span> entries
            </p>

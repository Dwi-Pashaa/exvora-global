...
@section('content')
    ...
    <div class="card mb-3">
        <div class="card-header">
            <a href="{{ route('pages.slider.create') }}" class="btn btn-primary">
                Tambah
            </a>
        </div>
        ...
        <div class="card-footer d-flex align-items-center">
            {{-- <p class="m-0 text-secondary">
                Showing <span>{{ $slider->firstItem() }}</span> 
                to <span>{{ $slider->lastItem() }}</span> of
                <span>{{ $slider->total() }}</span> entries
            </p>

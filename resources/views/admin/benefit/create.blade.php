...
@section('content')
    <form action="{{ route('pages.benefit.store') }}" method="POST">
        @csrf

        <div class="my-3">
            <div class="alert alert-primary">
                Untuk mencari icon silahkan ke website 
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{ route('pages.benefit') }}" class="btn btn-primary">
                    Kembali
                </a>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            <label for="" class="mb-2">Judul (Bahasa Indonesia)</label>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            <label for="" class="mb-2">Judul (Bahasa Inggris)</label>

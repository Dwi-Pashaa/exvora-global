...
@section('content')
    ...
    <div class="card mb-3">
        <div class="card-header">
            <a href="{{ route('pages.benefit.create') }}" class="btn btn-primary">
                Tambah
            </a>
        </div>
        ...
        <div class="card-footer d-flex align-items-center">
            <p class="m-0 text-secondary">
                Showing <span>{{ $benefit->firstItem() }}</span> 
                to <span>{{ $benefit->lastItem() }}</span> of
                <span>{{ $benefit->total() }}</span> entries
            </p>
...
@push('js')
    <script>
        const BASE = "{{ route('pages.benefit') }}";
